...
*@Chiara Vergeat 
*
*please note PS 2 is below PS1 (starting from row 73)
*
*==============================================================================*
...
***2)
	 ...
	 reg l_wage l_wage_hat ed0 exp /* shvbcskdcs */ 
	 eststo m2
	 drop l_wage_hat
...
*==============================================================================*
			...
			starlevels(* 0.10 ** 0.05 *** 0.01) stats(N r2 , fmt(%9.0fc 3 3) l("Observations" "R_squared")) varlabels( ed0 "education" exp "experience" exp_2 "experience^2" l_wage_hat "pred.ln(wage)" exp_hat_2 "p.o. experience") 
